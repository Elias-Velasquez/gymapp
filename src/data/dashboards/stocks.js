export let
    ...
    trendingStocks = [
        { id: 1, iconClass: 'avatar-rounded bg-light', icon: "bi-apple text-muted fs-18", percentageIconClass: "ti ti-arrow-bear-right", name: "Apple", count: "$12,289.44", percentage: "0.14%", money: "+$1,780.80" },
        { id: 2, iconClass: 'avatar-rounded bg-light', icon: "bi-currency-bitcoin text-warning fs-18", percentageIconClass: "ti ti-arrow-bear-right", name: "Bitcoin", count: "$58,151.02", percentage: "2.14%", money: "+$5,745.62" },
        { id: 3, iconClass: 'avatar-rounded bg-light', icon: "bi-card-list text-success fs-18", percentageIconClass: "ti ti-arrow-bear-right", name: "Tesla", count: "$14,452.36", percentage: "4.02%", money: "+$4,125.63" },
        { id: 4, iconClass: 'avatar-rounded bg-light', icon: "bi-gift text-primary fs-18", percentageIconClass: "ti ti-arrow-bear-right", name: "Amazon", count: "$63,251.11", percentage: "5.14%", money: "+$936.30" },
        { id: 5, iconClass: 'avatar-rounded bg-light', icon: "bi-truck text-danger fs-18", percentageIconClass: "ti ti-arrow-bear-right", name: "Aliexpress", count: "$5,401.50", percentage: "3.32%", money: "+$4,360.65" },
        { id: 6, iconClass: 'avatar-rounded bg-light', icon: "bi-phone text-secondary fs-18", percentageIconClass: "ti ti-arrow-bear-right", name: "Samsung", count: "$10,732.12", percentage: "1.24%", money: "+$3,221.29" },
    ],
    github = [
