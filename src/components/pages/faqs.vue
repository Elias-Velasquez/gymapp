<script lang="ts">
import { customerSupport, generalTopics } from "../../data/pages/faqs";
...
<template>
    ...
    <div class="row justify-content-center mb-5">
        ...
        <div class="col-xl-10">
            <div class="row">
                <div class="col-xl-6">
                    <SimpleCardComponent title="General Topics ?">
                ...
                <div class="col-xl-6">
                    <SimpleCardComponent title="Customer Support ?">
                        <div class="accordion accordion-customicon1 accordion-primary" id="accordionFAQ3">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingcustomicon3Three">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapsecustomicon3Three" aria-expanded="false"
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingcustomicon3Four">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapsecustomicon3Four" aria-expanded="false"
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent
                        :title="`Still Have Questions ? <span class='subtitle fw-normal text-muted d-block fs-12'> You can post your questions here, our support team is always active. </span>`"
                        :showCardFooter="true">
                        <div class="row gy-3">
                            <div class="col-xl-6">
                            ...
                            <div class="col-xl-12">
                                ...
                                <textarea class="form-control form-control-light" placeholder="Enter your question here"
