...
<template>
    ...
    <div ref="main-chart-wrapper" class="main-chart-wrapper p-2 gap-2 d-lg-flex">
                    ...
                    <PerfectScrollbar>
                        <div class="chat-users-tab">
                            ...
                            <ul class="list-unstyled mb-0 mt-2 ">
                                ...
                                <li v-for="(group, key) in chatList?.groupChat" :key="key" :class="`checkforactive ${group.class}`">
                                                ...
                                                <p class="fs-12 mb-0  " :class="group.howisTyping ? 'chat-msg-typing' : ''">
                                                    <span class="chat-msg text-truncate">
                                                        ...
                                                        <template v-if="group.lastMsg">
                                                          <span v-html="group.whoslastMsg + ' : ' + group.lastMsg"></span>
                                                        </template>
                                                    </span>
        ...
        <div class="main-chat-area border">
            ...
            <div class="" id="main-chat-content" >
                    <PerfectScrollbar>
                    <ul class="list-unstyled chat-content-custom-list chat-content">
                                    ...
                                    <div class="main-chat-msg">
                                        ...
                                        <div>
                                            <p class="mb-0 d-sm-flex d-block">
                                                <router-link to="/apps/gallery" class="avatar avatar-xl m-1"><img
                                                        src="/images/media/media-64.jpg" alt=""></router-link>
                                                <router-link to="/apps/gallery" class="avatar avatar-xl m-1"><img
                                                        src="/images/media/media-63.jpg" alt=""></router-link>
                                                <router-link to="/apps/gallery" class="avatar avatar-xl m-1"><img
                                                        src="/images/media/media-62.jpg" alt=""></router-link>
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <PerfectScrollbar ref="chat-user-details" class="chat-user-details border p-4"
            ...
            <div class="mb-0">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                        <router-link to="/apps/gallery" class="chat-media">
