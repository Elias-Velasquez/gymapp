    ...
    data() {
        return {
            dataToPass: {
                ...
                list: ['Pages', 'Invoice', 'Create Invoice']
            },
            currencySelect: null,
            singleSelecteValue: null,
            singleSelecteOptions: ['CHF - (Swiss Franc)', 'KWD - (Kuwaiti Dinar)', 'BHD - (Bahraini Dinar)', 'USD - (United States Dollar)'],
        };
    },
    setup() {
        ...
        return { quantity1, quantity2, picked, picked1 };
    },
    methods: {
        increaseQuantity1() {
            this.quantity1 += 1;
        ...
        validateQuantity1() {
            const value = parseInt(this.quantity1, 10);
        ...
        validateQuantity2() {
            const value = parseInt(this.quantity2, 10);
            if (isNaN(value) || value < 1) {
                this.quantity2 = 1;
            } else {
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="row gy-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 ms-auto mt-sm-0 mt-3">
                                    ...
                                    <div class="row gy-2">
                                        <div class="col-xl-12">
                                            <input type="text" class="form-control form-control-light"
                                                id="customer-Name" placeholder="Customer Name" value="Json Taylor">
                                        </div>
                                        <div class="col-xl-12">
                                        ...
                                        <div class="col-xl-12 choices-control invoice-currency-dropdown">
                        ...
                        <div class="col-xl-3 invoice-input">
                                            ...
                                            <td class="invoice-quantity-container">
                                                <div class="input-group border rounded flex-nowrap">
                                                    <button
                                                        ...
                                                        @click="decreaseQuantity1">
                                                        <i class="ri-subtract-line"></i>
                                                    </button>
                                                    <input type="text"
                                                        class="form-control form-control-sm border-0 text-center w-100"
                                                        aria-label="quantity" v-model="quantity1"
                                                        @input="validateQuantity1" />
                                                    <button
                                                        class="btn btn-icon btn-primary input-group-text flex-fill product-quantity-plus"
                                                        @click="increaseQuantity1">
                                                        <i class="ri-add-line"></i>
                                                    </button>
                                                </div>
                                            </td>
                                            <td>
                                                <input class="form-control form-control-light" placeholder=""
                                                    type="text" value="$60.00">
                                            </td>
                                            <td>
                                                <input class="form-control form-control-light" placeholder=""
                                                    type="text" value="$120.00">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="invoice-quantity-container">
                                                <div class="input-group border rounded flex-nowrap">
                                                    <button
                                                        class="btn btn-icon btn-primary input-group-text flex-fill product-quantity-minus"
                                                        @click="decreaseQuantity2">
                                                        <i class="ri-subtract-line"></i>
                                                    </button>
                                                    <input type="text"
                                                        class="form-control form-control-sm border-0 text-center w-100"
                                                        aria-label="quantity" v-model="quantity2"
                                                        @input="validateQuantity2" />
                                                    <button
                                                        class="btn btn-icon btn-primary input-group-text flex-fill product-quantity-plus"
                                                        @click="increaseQuantity2">
                                                        <i class="ri-add-line"></i>
                                                    </button>
                                                </div>
                                            </td>
                    ...
                    <div class="row gy-3">
                        <div class="col-xl-12">
                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                ...
                                <label class="btn btn-outline-light mt-sm-0 mt-1" for="btnradio3">Credit/Debit
                                    Card</label>
                            </div>
                        </div>
                        <div class="col-xl-12">
