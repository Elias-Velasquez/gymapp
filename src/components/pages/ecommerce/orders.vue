...
import { orderedProducts } from '../../../data/pages/ecommerce/products';
                ...
                <div class="card-body d-flex align-items-center flex-wrap">
                    <div class="flex-fill">
                        <span class="mb-0 fs-14 text-muted">Total number of orders placed upto now : <span
                                class="fw-semibold text-success">28</span></span>
                    </div>
                    <div class="dropdown">
        ...
        <div v-for="item in orderedProducts" class="col-xl-6 col-xxl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="card custom-card">
                ...
                <div v-if="item.status"
                    class="card-footer d-sm-flex d-block align-items-center justify-content-between">
