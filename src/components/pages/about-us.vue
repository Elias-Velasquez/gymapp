...
import TeamCardComponent from '../../shared/components/@spk/team-card.vue'
...
export default {
    components: {
        PageHeader, CountUp, TeamCardComponent
    },
    data() {
        return {
            dataToPass: {
            ...
            team: [
                {
                    id: 1, name: "Samantha Taylor", email: "samanthataylor2145@gmail.com", image: face4, socialMedia: [
                ...
                {
                    id: 2, name: "Peter Parker", email: "peterparker29@gmail.com", image: face15, socialMedia: [
                        { name: "facebook", links: "", icon: "facebook", iconColor: "primary" },
                        { name: "twitter", links: "", icon: "twitter-x", iconColor: "secondary" },
                        { name: "instagram", links: "", icon: "instagram", iconColor: "warning" }
                    ]
                ...
                {
                    id: 3, name: "Andrew garfield", email: "andrewgarfield98@gmail.com", image: face12, socialMedia: [
                        { name: "facebook", links: "", icon: "facebook", iconColor: "primary" },
                        { name: "twitter", links: "", icon: "twitter-x", iconColor: "secondary" },
                        { name: "instagram", links: "", icon: "instagram", iconColor: "warning" }
                    ]
                ...
                {
                    id: 4, name: "Elizabeth Rose", email: "elizabethrose@gmail.com", image: face5, socialMedia: [
                        { name: "facebook", links: "", icon: "facebook", iconColor: "primary" },
                        { name: "twitter", links: "", icon: "twitter-x", iconColor: "secondary" },
                        { name: "instagram", links: "", icon: "instagram", iconColor: "warning" }
                    ]
                ...
                {
                    id: 5, name: "Stuart Benny", email: "stuartbenny@gmail.com", image: face11, socialMedia: [
                        { name: "facebook", links: "", icon: "facebook", iconColor: "primary" },
                        { name: "twitter", links: "", icon: "twitter-x", iconColor: "secondary" },
                        { name: "instagram", links: "", icon: "instagram", iconColor: "warning" }
                    ]
                ...
                {
                    id: 6, name: "Sasha Banks", email: "sashabanks89@gmail.com", image: face2, socialMedia: [
                        { name: "facebook", links: "", icon: "facebook", iconColor: "primary" },
                        { name: "twitter", links: "", icon: "twitter-x", iconColor: "secondary" },
                        { name: "instagram", links: "", icon: "instagram", iconColor: "warning" }
                    ]
                ...
                {
                    id: 7, name: "Alicia Keys", email: "aliciakeys99@gmail.com", image: face8, socialMedia: [
                        { name: "facebook", links: "", icon: "facebook", iconColor: "primary" },
                        { name: "twitter", links: "", icon: "twitter-x", iconColor: "secondary" },
                        { name: "instagram", links: "", icon: "instagram", iconColor: "warning" }
                    ]
                ...
                {
                    id: 8, name: "Jason Mama", email: "jasonmama143@gmail.com", image: face9, socialMedia: [
                        { name: "facebook", links: "", icon: "facebook", iconColor: "primary" },
                        { name: "twitter", links: "", icon: "twitter-x", iconColor: "secondary" },
                        { name: "instagram", links: "", icon: "instagram", iconColor: "warning" }
                    ]
                    ...
                    <div class="aboutus-banner-content">
                        <div class="row">
                            ...
                            <div class="col-xxl-6 col-xl-6 aboutus-banner-img">
                                <img src="/images/media/media-80.svg" class="img-fluid" alt="">
                            </div>
                                    ...
                                    <div class="col-xxl-5 col-xl-8 col-lg-10 col-md-8 col-sm-10 col-10">
                                        <div class="card custom-card text-default shadow border">
                                            <div class="card-body p-0">
                                                <div class="row">
                                                    <div
                                                        class="col-xl-4 col-xxl-4 col-lg-4 col-md-4 col-sm-4 about-company-stats-border">
                                                        <div
                                                            class="text-center p-4 w-100 h-100 d-flex align-items-center justify-content-center">
                                                            <div>
                                                                <span class="fw-semibold">Projects</span>
                                                                <p class="text-dark fs-2 mb-0 d-flex">
                                                                    <count-up :end-val="137"></count-up>
                                                                    +
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="text-dark fs-2 mb-0 d-flex"><span><count-up
                                                                            :end-val="2500"></count-up></span>+</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-4 col-xxl-4 col-lg-4 col-md-4 col-sm-4">
                                                        <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="text-dark fs-2 mb-0"><count-up
                                                                        :end-val="22"></count-up></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="row pb-5 px-3 about-motto">
                    <div class="col-xxl-5 col-xl-8 col-lg-10 col-md-10 col-sm-12">
                        <div class="text-justify">
                            <div class="text-dark fs-26 fw-semibold mb-4"><span class="about-heading">Our Mission</span>
                            </div>
                ...
                <div class="py-5 px-3 bg-light">
                    <div class="row justify-content-center">
                        <div class="col-xxl-8 col-xl-10">
                            ...
                            <div class="row">
                                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12" v-for="card in team"
                                    :key="card.id">
                                    <TeamCardComponent customCardClass="text-center" :card="card">
                                    </TeamCardComponent>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="text-center">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Ask Here" aria-label="Ask Here"
