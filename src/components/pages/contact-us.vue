                ...
                <div class="card-body p-0">
                    <div class="contact-page-banner">
                        <div class="text-center">
                            ...
                            <h6 class="text-fixed-white mb-4 px-sm-0 px-3">Have any questions ? We would love to hear
                                from you. </h6>
                            <button class="btn btn-success btn-wave">Contact <i
                                    class="ri-phone-line ms-1 align-middle"></i></button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <input type="text" class="form-control form-control-light"
                                        id="contact-address-lastname" placeholder="Enter Name">
                                </div>
                                <div class="col-xl-6">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <textarea class="form-control form-control-light" id="contact-address-address"
                                        rows="2"></textarea>
                                </div>
                                <div class="col-xl-6">
                                    <label for="contact-mail-message" class="form-label">Message :</label>
                                    <textarea class="form-control form-control-light" id="contact-mail-message"
                                        rows="2"></textarea>
                                </div>
                            </div>
                        </div>
