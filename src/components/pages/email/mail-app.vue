...
export default {
    ...
    data() {
        return {
            ...
            content: '',
            singleSelecteValue: ['jay@gmail.com'],
            singleSelecteOptions: ['kimo@gmail.com', 'don@gmail.com', 'kia@gmail.com', 'jay@gmail.com'],
            WindowPreSize: [window.innerWidth],
            mailItems: [
                { id: 1, avatar: face5, sender: 'Sujika', time: '1:32PM', subject: 'New Project details', attachment: "attachment", snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: false },
                { id: 2, avatar: face12, sender: 'Michael Jeremy', liClass: "active", time: '10:27AM', subject: 'History of planets are discovered yesterday.', text: "muted", snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: true },
                { id: 3, avatar: face14, badge: "Promotion", badgeColor: "success", sender: 'King Berunda', time: 'Yesterday, 10:27AM', text: "muted", subject: 'Request for return of item?', snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: false },
                { id: 4, avatar: face7, badge: "Social", badgeColor: "primary", sender: 'Samantha May', time: '24 Oct, 5:45PM', text: "muted", subject: 'Completion of work is pending', snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: true },
                { id: 5, avatar: face15, sender: 'Alex Carey', time: '12 Sep, 11:24AM', subject: 'Most Probable date of project completion', snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: false },
                { id: 6, avatar: face16, badge: "Personal", badgeColor: "danger", sender: 'Dawn Bradshaw', time: '11 Sep, 10:32AM', subject: 'Personal Mail', snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: false },
                { id: 7, avatar: face3, sender: 'Kiara Jah', time: '08 Aug, 08:12AM', subject: 'Applying for bank loan?', text: "muted", snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: false },
                { id: 8, avatar: face13, sender: 'David Subhman', time: '16 July, 05:52PM', subject: 'Life Insurance Corporation.', text: "muted", snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: false },
            ],
            mainImgSrc: {
                avatar: face12,
                sender: 'Michael Jeremy',
            },
            recipients: [
                { name: 'Samantha May', image: face7, status: 'online' },
                { name: 'Brenda', image: face4, status: 'offline' },
                { name: 'Monika', image: face8, status: 'online' },
                { name: 'Kiara Jah', image: face3, status: 'offline' },
                { name: 'Sujika', image: face11, status: 'offline' },
                { name: 'Kim Noah', image: face16, status: 'online' },
                { name: 'Professor', image: face10, status: 'offline' },
                { name: 'Alex Carey', image: face15, status: 'offline' },
                { name: 'Monika', image: face3, status: 'offline' }
            ],
            navSections: [
                {
                    title: 'MAILS',
                ...
                {
                    name: 'All Mails',
                    iconClass: 'ri-inbox-archive-line align-middle fs-14',
                    badge: '12,456',
                    badgeClass: 'bg-success-transparent rounded-pill',
                    active: true,
                    clickAction: this.showMessages
                },
                {
                    name: 'Inbox',
                    iconClass: 'ri-inbox-archive-line align-middle fs-14',
                    badge: '8',
                    badgeClass: 'bg-primary-transparent rounded-circle',
                    active: false,
                    clickAction: this.showMessages
                },
                {
                    name: 'Sent',
                    iconClass: 'ri-send-plane-2-line align-middle fs-14',
                    active: false,
                    clickAction: this.showMessages
                },
                {
                    name: 'Drafts',
                    iconClass: 'ri-draft-line align-middle fs-14',
                    active: false,
                    clickAction: this.showMessages
                },
                {
                    name: 'Spam',
                    iconClass: 'ri-spam-2-line align-middle fs-14',
                    badge: '4',
                    badgeClass: 'bg-danger-transparent rounded-circle',
                    active: false,
                    clickAction: this.showMessages
                },
                {
                    name: 'Important',
                    iconClass: 'ri-bookmark-line align-middle fs-14',
                    active: false,
                    clickAction: this.showMessages
                },
                {
                    name: 'Trash',
                    iconClass: 'ri-delete-bin-line align-middle fs-14',
                    active: false,
                    clickAction: this.showMessages
                },
                {
                    name: 'Archive',
                    iconClass: 'ri-archive-line align-middle fs-14',
                    active: false,
                    clickAction: this.showMessages
                },
                {
                    name: 'Starred',
                    iconClass: 'ri-star-line align-middle fs-14',
                    badge: '12',
                    badgeClass: 'bg-warning-transparent rounded-circle',
                    active: false,
                    clickAction: this.showMessages
                },
                {
                ...
                {
                    name: 'Settings',
                    iconClass: 'ri-settings-3-line align-middle fs-14',
                    active: false,
                    clickAction: this.showSettings
                },
                {
                    title: 'LABELS',
                },
                {
                    name: 'Mail',
                    iconClass: 'ri-price-tag-line align-middle fs-14 fw-semibold text-secondary',
                    active: false,
                    clickAction: this.showLabel
                },
                {
                    name: 'Home',
                    iconClass: 'ri-price-tag-line align-middle fs-14 fw-semibold text-danger',
                    active: false,
                    clickAction: this.showLabel
                },
                {
                    name: 'Work',
                    iconClass: 'ri-price-tag-line align-middle fs-14 fw-semibold text-success',
                    active: false,
                    clickAction: this.showLabel
                },
                {
                    name: 'Friends',
                    iconClass: 'ri-price-tag-line align-middle fs-14 fw-semibold text-dark',
                    active: false,
                    clickAction: this.showLabel
                },
                {
                ...
                },
                {
                    ...
                    avatar: face4,
                    status: 'online',
                    lastMessage: 'Hello this is angelica.',
                    active: false,
                    clickAction: this.showUser
                },
                {
                    name: 'Rexha',
                    avatar: face6,
                    status: 'online',
                    lastMessage: 'Thanks for sharing file &#128512;.',
                    active: false,
                    clickAction: this.showUser
                }
            ]
    ...
    methods: {
        ...
        handleLinkClick(avatar: string, sender: string) {
            this.mainImgSrc = {
                avatar: avatar,
                sender: sender,
            };
    ...
    <div class="main-mail-container p-2 gap-2 d-flex">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 mb-2">
                                        <label for="toMail" class="form-label">To<sup><i
                                                    class="ri-star-s-fill text-success fs-8"></i></sup></label>
                                        <multiselect1 :show-labels="false" v-model="singleSelecteValue" :multiple="true"
            ...
            <div>
                <PerfectScrollbar>
                    <ul class="list-unstyled mail-main-nav" id="mail-main-nav">
                        <li class="" v-for="(section, index) in navSections" :key="index"
                            :class="section.active ? 'active mail-type' : 'mail-type', section.title ? 'px-0 pt-0' : ''">
                            <span v-if="section.title" class="fs-11 text-muted op-7 fw-semibold">{{ section.title
                            }}</span>
                            <a @click="section.clickAction" href="javascript:void(0);">
                                <div v-if="section.avatar" class="d-flex align-items-top lh-1">
                                    <div class="me-2">
                                        <span class="avatar avatar-sm avatar-rounded" :class="section.status">
                                            <img :src="section.avatar" alt="">
                                        </span>
                                    </div>
                                    <div>
                                        <p class="text-default fw-semibold mb-1">{{ section.name }}</p>
                                        <p class="fs-12 text-muted mb-0" v-html="section.lastMessage"></p>
                                    </div>
                                </div>
                                <div v-if="!section.avatar" class="d-flex align-items-center">
                                    <span class="me-2 lh-1">
                                        <i :class="section.iconClass"></i>
                                    </span>
                                    <span class="flex-fill text-nowrap">{{ section.name }}</span>
                                    <span v-if="section.badge" class="badge" :class="section.badgeClass">{{
                                        section.badge }}</span>
                                </div>
                            </a>
                        </li>
        ...
        <div ref="total-mails" class="total-mails border">
            <div class="p-3 d-flex align-items-center border-bottom">
                ...
                <button @click="totalmailscloseFn"
                    class="btn btn-icon btn-light me-1 d-lg-none d-block total-mails-close" data-bs-toggle="tooltip"
            ...
            <PerfectScrollbar class="mail-messages" id="mail-messages">
                <ul class="list-unstyled mb-0 mail-messages-container">
                    <li v-for="mailapp in mailItems" :key="mailapp.id" :class="mailapp.liClass">
                        <div @click="showMailDetail" class="d-flex align-items-top">
                            <div class="me-3 mt-1">
                                <input class="form-check-input" type="checkbox" id="checkboxNoLabel1" value=""
                                    aria-label="..." :checked="mailapp.cheacked">
                            </div>
                            <div class="me-1 lh-1">
                                <span class="avatar avatar-md online me-2 avatar-rounded mail-msg-avatar">
                                    <img :src="(mailapp.avatar)" alt="">
                                </span>
                            </div>
                            <div class="flex-fill">
                                <a href="javascript:void(0);"
                                    @click="handleLinkClick((mailapp.avatar), mailapp.sender)">
                                    <p class="mb-1 fs-12">
                                        {{ mailapp.sender }}
                                        <span :class="`badge bg-${mailapp.badgeColor}`" v-if="mailapp.badge">{{
                                            mailapp.badge }}</span>
                                        <span class="float-end text-muted fw-normal fs-11">
                                            <span class="me-2" v-if="mailapp.attachment">
                                ...
                                <p class="mail-msg mb-0">
                                    <span class="d-block mb-0 fw-semibold text-truncate">{{ mailapp.subject }}</span>
                                    <span class="fs-11 text-muted text-wrap text-truncate">
                                        {{ mailapp.snippet }}
                                        <button class="btn p-0 lh-1 mail-starred true border-0 float-end">
                                            <i :class="`ri-star-fill fs-14 text-${mailapp.text}`"></i>
                                        </button>
                                    </span>
                                </p>
                            </div>
        ...
        <div ref="mails-information" class="mails-information border">
            <div class="mail-info-header d-flex flex-wrap gap-2 align-items-center">
                <div class="me-1">
                    <span class="avatar avatar-md online me-2 avatar-rounded mail-msg-avatar">
                        <img :src="mainImgSrc.avatar" alt="">
                    </span>
                </div>
                <div class="flex-fill">
                    <h6 class="mb-0 fw-semibold">{{ mainImgSrc.sender }}</h6>
                    <span class="text-muted fs-12">michaeljeremy2194@gmail.com</span>
                </div>
                <div class="mail-action-icons">
                    <button type="button" class="btn btn-icon btn-light me-2" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Starred">
                    ...
                    <button type="button" class="btn btn-icon btn-light" data-bs-toggle="tooltip"
            ...
            <PerfectScrollbar>
                <div class="mail-info-body p-4" id="mail-info-body">
                    ...
                    <div class="main-mail-content mb-4">
                        ...
                        <p class="mb-2 fs-12 text-muted">Earth, our home, is the third planet from the sun. While
                            scientists
                            continue to hunt for clues of life beyond Earth, our home planet remains the only place in
                            the
                            universe where we've ever identified living organisms. .</p>
                        <p class="mb-2 fs-12 text-muted">Earth has a diameter of roughly 8,000 miles (13,000 kilometers)
                            and
                            is
                            mostly round because gravity generally pulls matter into a ball. But the spin of our home
                            planet
                            causes it to be squashed at its poles and swollen at the equator, making the true shape of
                            the
                            Earth
                    ...
                    <div class="mail-attachments mb-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="mb-0">
                                <span class="fs-14 fw-semibold"><i
                                        class="ri-attachment-2 me-1 align-middle"></i>Attachments
                                    (1.8mb):</span>
                            </div>
                            <div>
                        ...
                        <div class="mt-2 d-flex flex-wrap">
                            ...
                            <a href="javascript:void(0);" class="btn btn-icon btn-outline-light ms-2 btn-lg mb-1 lh-1"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="Image_012.jpeg">
            ...
            <div class="mail-info-footer d-flex flex-wrap gap-2 align-items-center justify-content-between">
                <div>
                    ...
                    <button type="button" class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip"
        ...
        <div class="mail-recepients border">
            ...
            <PerfectScrollbar class="p-3 d-flex flex-column align-items-center total-mail-recepients"
                id="mail-recepients">
                <a href="javascript:void(0);" class="mail-recepeint-person" v-for="(recipient, index) in recipients"
                    :key="index">
                    <span :class="['avatar', recipient.status, 'avatar-rounded']">
                        <v-tooltip activator="parent" location="left">{{ recipient.name }}</v-tooltip>
