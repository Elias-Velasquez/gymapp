...
<template>
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Navbar with sub-component">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Brand With And Without Links">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Image and text">
                <nav class="navbar bg-light">
                    <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Nav with lists, links and dropdowns">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Forms In Navbar">
                <nav class="navbar bg-light mb-3">
                    <div class="container-fluid">
                        <form class="d-flex" role="search">
                            <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Navbar With Text">
                <nav class="navbar bg-light mb-3">
                    <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Transparent Color Schemes">
        ...
        <div class="col-xl-12">
            <SimpleCardComponent title="Solid Color Schemes">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Containers">
                <h6>Too center</h6>
                <div class="container">
                    <nav class="navbar navbar-expand-lg bg-light mb-3">
                        <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Placement">
                <nav class="navbar bg-light">
                    <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Scrolling">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarScroll">
                            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll"
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="javascript:void(0);"
                                        id="navbarScrollingDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                        Link
                                    </a>
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Responsive behaviors Toggler">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="External content">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Offcanvas">
