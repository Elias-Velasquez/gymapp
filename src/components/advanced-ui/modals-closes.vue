...
import * as prism from '../../data/prismCode/advancedUi/modals.js';
...
<template>
        ...
        <div class="col-xl-4">
            <showcodeCard :code="prism.scrollingLongContent" title="Scrolling long content">
                ...
                <div class="modal fade" id="exampleModalScrollable" tabindex="-1"
                    aria-labelledby="exampleModalScrollable" data-bs-keyboard="false" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <p>
                                    <a href="javascript:void(0);" class="text-primary" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Tooltip">Thislink</a> and
                                    <a href="javascript:void(0);" class="text-primary" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Tooltip">that link </a> have tooltips
                                    on
                                    hover.
                                </p>
                            </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            <showcodeCard :code="prism.whiteVariant" title="White variant" custom-card-body-class="bg-black">
