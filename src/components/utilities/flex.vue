...
<template>
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="Enable flex behaviors">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Direction">
                <div class="bd-example flex-container">
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="Direction flex-column and flex-column-reverse">
                <div class="bd-example flex-container mb-3">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Justify content">
                <div class="bd-example flex-container mb-3">
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="Align items">
                <div class="bd-example flex-container mb-3">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Align self">
                <div class="bd-example flex-container mb-3">
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-12">
                    <SimpleCardComponent
                        title=" Align content ( Heads up! This property has no effect on single rows of flex items.)">
                        <div class="bd-example flex-container mb-3">
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title="Order">
                        <div class="bd-example flex-container mb-3">
        ...
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-12">
                    <SimpleCardComponent title="Fill">
                        <div class="bd-example flex-container mb-3">
                            <div class="d-flex">
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title="Grow and shrink">
                        <div class="bd-example flex-container mb-3">
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title=" Auto margins">
                        <div class="bd-example flex-container mb-3">
                            <div class="d-flex mb-3">
                                <div class="p-2">Flex item</div>
                                <div class="p-2">Flex item</div>
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title="Wrap">
                        <div class="bd-example flex-container mb-3">
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title="With align-items">
                        <div class="bd-example flex-container mb-3">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Media object">
                <div class="d-sm-flex mb-3">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        voluptas nobis consectetur. Voluptate pariatur, odit repudiandae sint, libero laborum aut vel,
                        ut enim laboriosam explicabo dolor corporis hic.
                    </div>
                </div>
                ...
                <div class="d-sm-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        deserunt provident rem illum exercitationem laborum pariatur modi blanditiis a dolor excepturi
                        qui, aut laudantium harum in id..
                    </div>
                </div>
            </SimpleCardComponent>
        </div>
