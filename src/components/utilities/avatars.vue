...
import * as prism from "../../data/prismCode/utilities/avatar.js";
...
<template>
    ...
    <div class="row">
        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
            <showcodeCard :code="prism.avatars" title="Avatars" custom-card-body-class="py-4">
