...
<template>
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-6">
            <SimpleCardComponent title="Background Colors">
        ...
        <div class="col-lg-12 col-sm-6">
            <SimpleCardComponent title="Background gradients">
                <div class="row row-cols-12 d-flex align-items-center">
                    <div class="p-3 col">
        ...
        <div class="col-lg-12 col-sm-6">
            <SimpleCardComponent title="Background transparent colors">
                <div class="row row-cols-12 d-flex align-items-center">
                    <div class="p-3 col">
        ...
        <div class="col-lg-12 col-sm-6">
            <SimpleCardComponent title="Background outline colors">
                <div class="row row-cols-12 d-flex align-items-center">
                    <div class="p-3 col">
        ...
        <div class="col-lg-12 col-sm-6">
            <SimpleCardComponent title=" Border Colors">
                <div class="row row-cols-12 d-flex align-items-center">
                    <div class="p-3 col">
        ...
        <div class="col-lg-12 col-sm-6">
            <SimpleCardComponent title="Background Opacity">
                <div class="row row-cols-12 d-flex align-items-center">
                    <div class="p-3 col">
                    ...
                    <div class="p-3 col">
                        <div class="m-2 bg-success text-fixed-black bg-opacity-50 mx-auto color-container">50%</div>
                        <p class="pb-0 mb-0 fw-semibold text-center"><code>.bg-opacity-50</code></p>
                    </div>
                    <div class="p-3 col">
                        <div class="m-2 bg-success text-fixed-black bg-opacity-25 mx-auto color-container">25%</div>
                        <p class="pb-0 mb-0 fw-semibold text-center"><code>.bg-opacity-25</code></p>
                    </div>
                    <div class="p-3 col">
                        <div class="m-2 bg-success text-fixed-black bg-opacity-10 mx-auto color-container">10%</div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Text Colors">
                <div class="row row-cols-12 d-flex align-items-center">
                    <div class="p-3 col">
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="row">
                <div class="col-xl-12">
                    <SimpleCardComponent title="Text Opacity">
                        <div class="row row-cols-12 d-flex align-items-center">
                            <div class="p-3 col">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Callout">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent cardClassBody="d-xl-flex" :showCardHeader="false">
