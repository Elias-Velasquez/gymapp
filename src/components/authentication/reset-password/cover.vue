            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
                    <div class="p-5">
                        ...
                        <div class="btn-list">
                            <button class="btn btn-lg btn-light"><svg class="google-svg"
                                    xmlns="http://www.w3.org/2000/svg" width="2443" height="2500"
                        ...
                        <div class="row gy-3">
                            <div class="col-xl-12 mt-0">
                                ...
                                <div class="input-group">
                                    <input :type="showConfirmPassword ? 'text' : 'password'"
                                        class="form-control form-control-lg" id="reset-password"
                                        placeholder="current password">
                                    <button class="btn btn-light" @click="togglePassword('confirm')" type="button"
                                        id="button-addon2">
                                        <i :class="showConfirmPassword ? 'ri-eye-line' : 'ri-eye-off-line'"
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="input-group">
                                    <input :type="showCurrentPassword ? 'text' : 'password'"
                                        class="form-control form-control-lg" id="reset-newpassword"
                                        placeholder="new password">
                                    <button class="btn btn-light" @click="togglePassword('current')" type="button"
                                        id="button-addon21">
                                        <i :class="showCurrentPassword ? 'ri-eye-line' : 'ri-eye-off-line'"
                                            class="align-middle"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="col-xl-12 mb-3">
                                ...
                                <div class="input-group">
                                    <input :type="showNewPassword ? 'text' : 'password'"
                                        class="form-control form-control-lg" id="reset-confirmpassword"
                                        placeholder="confirm password">
                                    <button class="btn btn-light" @click="togglePassword('new')" type="button"
                                        id="button-addon22">
                                        <i :class="showNewPassword ? 'ri-eye-line' : 'ri-eye-off-line'"
                                            class="align-middle"></i>
                                    </button>
                                </div>
                                <div class="mt-2">
                            ...
                            <div class="col-xl-12 d-grid mt-2">
                                <router-link to="/authentication/sign-in/cover"
                                    class="btn btn-lg btn-primary">Create</router-link>
                            </div>
                        </div>
                        <div class="text-center">
                            <p class="fs-12 text-muted mt-4">Already have an account ? <router-link
                                    to="/authentication/sign-in/cover" class="text-primary">Sign In</router-link></p>
                        </div>
                    </div>
                </div>
            </div>
