                ...
                <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
                    <div class="p-5">
                        ...
                        <div class="btn-list">
                            ...
                            <button class="btn btn-icon btn-info-light"><i class="ri-twitter-x-fill"></i></button>
                        </div>
                            ...
                            <div class="col-xl-12 mt-0">
                                ...
                                <div class="input-group">
                                    <input :type="showPassword ? 'text' : 'password'"
                                        class="form-control form-control-lg" id="create-password"
                                        placeholder="password">
                                    <button @click="togglePassword('create-password')" class="btn btn-light"
                                        type="button">
                            ...
                            <div class="col-xl-12 mb-3">
                                ...
                                <div class="input-group">
                                    <input :type="showConfirmPassword ? 'text' : 'password'"
                                        class="form-control form-control-lg" id="create-confirmpassword"
                                        placeholder="password">
                                    <button @click="togglePassword('create-confirmpassword')" class="btn btn-light"
                                        type="button">
                        ...
                        <div class="text-center">
                            <p class="fs-12 text-muted mt-4">Back to home ? <router-link to='/dashboard/crm'
