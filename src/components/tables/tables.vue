...
export default {
    ...
    data() {
        return {
            ...
            tableHeader: ['<input class="form-check-input" type="checkbox" id="checkboxNoLabel1" aria-label="...">', 'Team Head', 'Category', 'Role', 'Gmail', 'Team', 'Work Progress', 'Revenue', 'Action'],
            tableData,
            prism,
...
<template>
    ...
    <div class="row">
        <div class="col-xl-6">
            <ShowcodeCard title="Basic Tables" :code="prism.basicTable">
                <TableComponent :headers="['Name', 'Created On', 'Number', 'Status']" :rows="tableData.basicRows"
        ...
        <div class="col-xl-6">
            <ShowcodeCard title="Bordered Tables" :code="prism.BorderedTables">
                <TableComponent :headers="['User', 'Status', 'Email', 'Action']" :rows="tableData.bordered"
    ...
    <div class="row">
        <div class="col-xl-4">
            <ShowcodeCard title="Bordered Primary" :code="prism.BorderedPrimary">
                <TableComponent :headers="['Order', 'Date', 'Customer', 'Action']" :rows="tableData.borderedPrimary"
        ...
        <div class="col-xl-4">
            <ShowcodeCard title="Bordered Success" :code="prism.BorderedSuccess">
                <TableComponent :headers="['Order', 'Date', 'Customer', 'Action']" :rows="tableData.borderedSuccess"
                    tableClass="table text-nowrap table-bordered border-success" v-slot:cell="{ row }">
                    <td>{{ row.id }}</td>
                    <td><span class="badge bg-light text-dark">{{ row.date }}</span></td>
                    <td>
                        <div class="d-flex align-items-center">
        ...
        <div class="col-xl-4">
            <ShowcodeCard title="Bordered warning" :code="prism.BorderedWarning">
                <TableComponent :headers="['Order', 'Date', 'Customer', 'Action']" :rows="tableData.borderedWarning"
                    tableClass="table text-nowrap table-bordered border-warning" v-slot:cell="{ row }">
                    <td>{{ row.id }}</td>
                    <td><span class="badge bg-light text-dark">{{ row.date }}</span></td>
                    <td>
                        <div class="d-flex align-items-center">
    ...
    <div class="row">
        <div class="col-xl-6">
            <ShowcodeCard title="Table Without Borders" :code="prism.TableWithoutBorders">
                <TableComponent :headers="['User Name', 'Transaction Id', 'Created', 'Status']"
        ...
        <div class="col-xl-6">
            <ShowcodeCard title="Table Group Divideres" :code="prism.TableGroupDivideres">
                <TableComponent :headers="['Product', 'Seller', 'Sale Percentage', 'Quantity Sold']"
    ...
    <div class="row">
        <div class="col-xl-6">
            <ShowcodeCard title="Striped rows" :code="prism.Stripedrows">
                <TableComponent :headers="['ID', 'Date', 'Customer', 'Action']" :rows="tableData.stripedRows"
                    tableClass="table text-nowrap table-striped" v-slot:cell="{ row }">
                    <td>{{ row.id }}</td>
                    <td>{{ row.date }}</td>
                    <td>{{ row.name }}</td>
                    <td>
        ...
        <div class="col-xl-6">
            <ShowcodeCard title="Striped columns" :code="prism.Stripedcolumns">
                <TableComponent :headers="['ID', 'Date', 'Customer', 'Action']" :rows="tableData.stripedRows"
                    tableClass="table text-nowrap table-striped-columns" v-slot:cell="{ row }">
                    <td>{{ row.id }}</td>
                    <td>{{ row.date }}</td>
                    <td>{{ row.name }}</td>
                    <td>
    ...
    <div class="row">
        <div class="col-xl-4">
            <ShowcodeCard title="Primary Table" :code="prism.PrimaryTable">
                <TableComponent :headers="['#', 'First', 'Last', 'Handle']" :rows="tableData.colorTable"
                    tableClass="table text-nowrap table-primary" v-slot:cell="{ row }">
                    <td>{{ row.id }}</td>
                    <td>{{ row.firstName }}</td>
                    <td>{{ row.lastName }}</td>
                    <td>{{ row.username }}</td>
        ...
        <div class="col-xl-4">
            <ShowcodeCard title="Secondary Table" :code="prism.SecondaryTable">
                <TableComponent :headers="['#', 'First', 'Last', 'Handle']" :rows="tableData.colorTable"
                    tableClass="table text-nowrap table-secondary" v-slot:cell="{ row }">
                    <td>{{ row.id }}</td>
                    <td>{{ row.firstName }}</td>
                    <td>{{ row.lastName }}</td>
                    <td>{{ row.username }}</td>
        ...
        <div class="col-xl-4">
            <ShowcodeCard title="Warning Table" :code="prism.WarningTable">
                <TableComponent :headers="['#', 'First', 'Last', 'Handle']" :rows="tableData.colorTable"
                    tableClass="table text-nowrap table-warning" v-slot:cell="{ row }">
                    <td>{{ row.id }}</td>
                    <td>{{ row.firstName }}</td>
                    <td>{{ row.lastName }}</td>
                    <td>{{ row.username }}</td>
        ...
        <div class="col-xl-4">
            <ShowcodeCard title="Dark Table" :code="prism.DarkTable">
                <TableComponent :headers="['#', 'First', 'Last', 'Handle']" :rows="tableData.colorTable"
                    tableClass="table text-nowrap table-dark" v-slot:cell="{ row }">
                    <td>{{ row.id }}</td>
                    <td>{{ row.firstName }}</td>
                    <td>{{ row.lastName }}</td>
                    <td>{{ row.username }}</td>
        ...
        <div class="col-xl-4">
            <ShowcodeCard title="Success Table With Striped Rows" :code="prism.SuccessTableWithStripedRows">
                <TableComponent :headers="['#', 'First', 'Last', 'Handle']" :rows="tableData.colorTable"
                    tableClass="table text-nowrap table-success table-striped" v-slot:cell="{ row }">
                    <td>{{ row.id }}</td>
                    <td>{{ row.firstName }}</td>
                    <td>{{ row.lastName }}</td>
                    <td>{{ row.username }}</td>
    ...
    <div class="row">
        <div class="col-xl-6">
            <ShowcodeCard title="Hoverable Rows" :code="prism.HoverableRows">
                <TableComponent :headers="['Product Manager', 'Category', 'Team', 'Status']"
        ...
        <div class="col-xl-6">
            <ShowcodeCard title="Hoverable rows With striped rows" :code="prism.HoverablerowsWithstripedrows">
                <TableComponent :headers="['Invoice', 'Customer', 'Status', 'Date']" :rows="tableData.hoverableRow"
    ...
    <div class="row">
        <div class="col-xl-4">
            <ShowcodeCard title="Table Foot" :code="prism.TableFoot">
                <TableComponent :headers="['S.No', 'Team', 'Matches Won', 'Win Ratio']" :rows="tableData.tableFoot"
                    tableClass="table text-nowrap" theadClass="table-primary" v-slot:cell="{ row }">
                    <td> {{ row.id }} </td>
                    <td> {{ row.location }}</td>
                    <td> {{ row.count }}</td>
        ...
        <div class="col-xl-4">
            <ShowcodeCard title="Table With Caption" :code="prism.TableWithCaption">
                <TableComponent :headers="['S.No', 'Country', 'Medals Won', 'No Of Athletes']"
        ...
        <div class="col-xl-4">
            <ShowcodeCard title="Table With Top Caption" :code="prism.TableWithTopCaption">
                ...
                <TableComponent :headers="['S.No', 'Name', 'Revenue', 'Country']" :rows="tableData.tableWithTopCaption"
                    tableClass="table text-nowrap caption-top" v-slot:cell="{ row }">
                    <td>{{ row.rank }}</td>
                    <td>{{ row.name }}</td>
                    <td>{{ row.revenue }}</td>
                    <td>{{ row.country }}</td>
    ...
    <div class="row">
        <div class="col-xl-6">
            <ShowcodeCard title="Active Tables" :code="prism.ActiveTables">
                <TableComponent :headers="['Name', 'Created On', 'Number', 'Status']" :rows="tableData.activeTables"
                    tableClass="table text-nowrap" v-slot:cell="{ row }" :trClass="trClass">
                    <td>{{ row.name }}</td>
                    <td>{{ row.date }}</td>
        ...
        <div class="col-xl-6">
            <ShowcodeCard title="Small Tables" :code="prism.SmallTables">
                <TableComponent :headers="['Invoice', 'Created Date', 'Status', 'Action']" :rows="tableData.smallTables"
                    tableClass="table text-nowrap table-sm" v-slot:cell="{ row }">
                    <td>
    ...
    <div class="row">
        <div class="col-xl-6">
            <ShowcodeCard title="Color variants tables" :code="prism.Colorvariantstables">
                <TableComponent :headers="['Color', 'Client', 'State', 'Quantity', 'Total Price']"
    ...
    <div class="row">
        <div class="col-xl-12">
            <ShowcodeCard title="Always responsive" :code="prism.Alwaysresponsive">
                <TableComponent :headers="tableHeader" :rows="tableData.alwaysResponsive" tableClass="table text-nowrap"
                    v-slot:cell="{ row }">
