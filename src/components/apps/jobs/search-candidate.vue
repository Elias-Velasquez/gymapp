...
import searchcandidate from "../../../shared/components/@spk/apps/searchcandidate.vue";
    ...
    data() {
        return {
            dataToPass: {
                ...
                list: ['Apps', 'Jobs', 'Search Candidate']
            },
            diffTolltips: [25000, 70000],
            min: 100,
            max: 100000,
            categorySelecteValue: ['All Categories'],
            categorySelecteOptions: ['All Categories', 'Software Dveloper', 'Web Developer', 'Software Architect', 'IT Hardware', 'Network Engineer', 'Angular Developer', 'React Developer'],
            expSelecteValue: 'Fresher',
            expSelecteOptions: ['Fresher', '1 Year Exp', '2 Year Exp', '3 Year Exp', '4 Year Exp', '5 Year Exp'],
            candidatesListData: [
                {
                    image: faces1, name: 'Brenda Simpson ', role: 'Software Developer', location: 'Kondapur, Hyderabad', rating: '4.5', review: '142', details: [
                        { icon: 'bi-mortarboard', name: 'Graduate' },
                        { icon: 'bi-moon-stars', name: 'flexible-shift' },
                        { icon: 'bi-clock', name: 'Immediate Joinee' },
                        { icon: 'bi-broadcast', name: 'Good at English' },
                    ], packageFrom: '$2,300', packageTo: '$3,678', languages: ['English, Hindi, Telugu'], skills: ['HTML', 'CSS', 'Javascript', 'Angular'],
                    bondAccept: '1', experience: '2 Years'
                },
                {
                    image: faces3, name: 'Dwayne Stort ', role: 'Web Developer', location: 'Gachibowli, Hyderabad', rating: '3', review: '35', details: [
                        { icon: 'bi-mortarboard', name: 'Post Graduate' },
                        { icon: 'bi-moon-stars', name: 'flexible-shift' },
                        { icon: 'bi-clock', name: 'Within 10 Days' },
                        { icon: 'bi-broadcast', name: 'Good at English' },
                    ], packageFrom: '$3,600', packageTo: '$4,700', languages: ['English, Telugu'], skills: ['Javascript', 'React', 'React Native', 'HTML'],
                    bondAccept: '2', experience: '4 Years'
                },
                {
                    image: faces21, name: 'Jasmine Kova ', role: 'Python Developer', location: 'Gachibowli, Chennai', rating: '3', review: '56', details: [
                    ...
                    ], packageFrom: '$4,300', packageTo: '$5,000', languages: ['English, Telugu'], skills: ['Python', 'Java', 'React', 'Angular'],
                    bondAccept: '0', experience: '5 Years'
                },
                {
                    image: faces5, name: 'Kiara Advain ', role: 'Java Developer', location: 'Gachibowli, Banglore', rating: '3', review: '13', details: [
                        { icon: 'bi-mortarboard', name: 'MBA' },
                        { icon: 'bi-moon-stars', name: 'Day-shift' },
                        { icon: 'bi-clock', name: 'Within 30 Days' },
                        { icon: 'bi-broadcast', name: 'Good at English' },
                    ], packageFrom: '$3,678', packageTo: '$3,678', languages: ['English, Hindi, Telugu'], skills: ['Java', 'Core Java'],
                    bondAccept: '2', experience: 'Fresher'
                },
                {
                    image: faces13, name: 'Json Taylor ', role: 'Angular Developer', location: 'Gachibowli, Nellore', rating: '4', review: '18', details: [
                        { icon: 'bi-mortarboard', name: 'MBA' },
                        { icon: 'bi-moon-stars', name: 'flexible-shift' },
                        { icon: 'bi-clock', name: 'Within 15 Days' },
                        { icon: 'bi-broadcast', name: 'Fluent at English' },
                    ], packageFrom: '$3,600', packageTo: '$4,700', languages: ['English, Hindi, Telugu'], skills: ['Java', 'Advanced Java', 'Angular', 'HTML'],
                    bondAccept: '2', experience: '5 Years'
                },
                {
                    image: faces21, name: 'Diego Sanch ', role: 'AWS Developer', location: 'Kukatpally, Hyderabad', rating: '3', review: '13', details: [
                        { icon: 'bi-mortarboard', name: 'MBA' },
                        { icon: 'bi-moon-stars', name: 'Day-shift' },
                        { icon: 'bi-clock', name: 'Within 30 Days' },
                        { icon: 'bi-broadcast', name: 'Good at English' },
                    ], packageFrom: '$8,900', packageTo: '$8,900', languages: ['English, Hindi, Telugu'], skills: ['AWS Lambda', 'Athena', 'Linux', 'Angular'],
                    bondAccept: '0', experience: 'Fresher'
                }
            ]
        };
    },
    ...
    <div class="container-lg">
        ...
        <div class="row">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="px-2 py-4 px-sm-4 border-bottom">
                            ...
                            <div class="px-2 py-3 pb-0">
                                <vue-slider class="mb-5" v-model="diffTolltips" :tooltip="'always'"
                                    :marks="[100, 100000]" :min="min" :max="max"
                                    :tooltip-placement="['top', 'bottom']"></vue-slider>
                                <div class="d-flex mt-5">
                                    <div class="fw-semibold h6 mb-0">$<span id="lower-value">{{ diffTolltips[0]
                                    }}</span>
                                    </div>
                                    &nbsp; -- &nbsp;
                                    <div class="fw-semibold h6 mb-0">$<span id="upper-value">{{ diffTolltips[1]
                                    }}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="px-2 py-4 px-sm-4">
                            ...
                            <div class="px-2 py-3 pb-0">
                                ...
                                <a class="ecommerce-more-link" data-bs-toggle="collapse" href="#sizes-more"
            ...
            <div class="col-xxl-9 col-xl-8">
                <div class="row align-items-center mb-4">
                    <div class="col-lg-12">
                        <div class="input-group companies-search-input">
                            ...
                            <multiselect1 :show-labels="false" class="w-sm-20 rounded-0" name="category" id="category"
                                v-model="categorySelecteValue" :multiple="false" :options="categorySelecteOptions">
                            </multiselect1>
                            <input type="text" class="form-control w-25"
                                aria-label="Text input with segmented dropdown button" placeholder="Search by location">
                            <multiselect1 :show-labels="false" class="w-sm-20 rounded-0" name="exp" id="exp"
                                v-model="expSelecteValue" :multiple="false" :options="expSelecteOptions">
                            </multiselect1>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <h5 class="fw-semibold mb-0 flex-grow-1">1287 <span class="fw-normal fs-18">Candidates match
                                    your job search</span> </h5>
                            <div class="btn-group">
                ...
                <searchcandidate :candidatesListData="candidatesListData" />
