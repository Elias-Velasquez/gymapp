...
import { ref } from "vue";
import { findjobs1, findjobs2, jobs } from "../../../data/apps/job-details";
...
import { Navigation, Pagination, Scrollbar, Mousewheel, Keyboard, EffectCube, EffectFade, EffectCoverflow, EffectFlip, FreeMode, Thumbs } from 'swiper/modules';
...
export default {
    ...
    setup() {
        ...
        return {
            ...
            modules: [Navigation, Pagination, Scrollbar, Mousewheel, Keyboard, EffectCube, EffectFade, EffectCoverflow, EffectFlip, FreeMode, Thumbs],
        };
    },
...
<template>
    ...
    <div class="container">
                        ...
                        <div>
                            <div class="btn-list mb-2">
                                <a href="javascript:void(0);" class="btn btn-primary me-2"><i
                                        class="fa fa-check me-1"></i> Apply Now</a>
                            ...
                            <p class="mb-0"><i class="bi bi-info-circle text-danger" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="45 days left"></i> <b>45 days left </b> to apply this
                                job</p>
                        </div>
                    </div>
                </SimpleCardComponent>
        ...
        <div class="row">
            <div class="col-xl-8">
                <SimpleCardComponent title="Job Highlights">
                    <div class="row">
                        <div class="col-sm-4">
                            <p class="fs-14 mb-2">
                ...
                <SimpleCardComponent :showCardHeader="false"
                    customCardClass="border bg-primary-transparent shadow-none">
                ...
                <div>
                    ...
                    <swiper class="notification-slider swiper-related-jobs" :navigation="true" :modules="modules">
                        <SwiperSlide>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card custom-card featured-jobs">
                                        <div class="card-body">
                                            <div class="btn-list float-end">
                                                ...
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-bs-original-title="Featured Jobs"><span><i
                                                            class="bi bi-star-fill"></i></span></a>
                                            </div>
                                            ...
                                            <div class="popular-tags mb-3">
                                                <a href="javascript:void(0);"
                                                    class="badge rounded-pill bg-light text-default me-1"><i
                ...
                <div class="card custom-card border">
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group list-group-flush">
                            <li v-for="(job, index) in jobs" :key="index" class="list-group-item mb-2">
                                <div class="d-sm-flex">
                                    <span class="avatar avatar-md avatar-rounded bg-primary bg-opacity-10 border"
                                        v-html="job.iconPath"> </span>
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1">
                                            <a href="javascript:void(0);">{{ job.title }}</a>
                                        </p>
                                        <p class="mb-0 me-3">
                                            <i class="bi bi-building text-muted"></i> {{ job.company }}
                                        </p>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="list-group list-group-flush">
                                ...
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);">Infratech PVT
                                                LTD</a></p>
                                        <p class="mb-0 me-3"><i class="bi bi-briefcase text-muted"></i> React Lead
                                            Developer </p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item mb-2">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);">Spruko
                                ...
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);">Hardware Private
                                                Solutions </a></p>
                                        <p class="mb-0 me-3"><i class="bi bi-briefcase text-muted"></i> Wordpress
                                            Developer</p>
                                    </div>
                                </div>
                            </li>
