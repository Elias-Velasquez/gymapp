...
import searchcompany from "../../../shared/components/@spk/apps/searchcompany.vue";
import companyLogos1 from '/images/company-logos/1.png';
import companyLogos2 from '/images/company-logos/2.png';
import companyLogos3 from '/images/company-logos/3.png';
import companyLogos7 from '/images/company-logos/7.png';
import companyLogos5 from '/images/company-logos/5.png';
import companyLogos6 from '/images/company-logos/6.png';
...
export default {
    ...
    data() {
        return {
            ...
            companyListData: [
                { logo: companyLogos1, name: "Spotech Technical Solutions", location: "Kondapur, Hyderabad", establishment: "Establishment year - 2019", reviews: "142", rating: "4", employees: "345", vacancies: "50", tooltips: [{ title: "Add to Wishlist", icon: "heart" }] },
                { logo: companyLogos2, name: "G Technical Solutions", location: "Gachibowli, Hyderabad,", establishment: "Establishment year - 2015", reviews: "134", rating: "4", employees: "146", vacancies: "40", tooltips: [{ title: "Add to Wishlist", icon: "heart" }] },
                { logo: companyLogos3, name: "Diego Technical Solutions", location: " Gachibowli, Chennai", establishment: "Establishment year - 2013", reviews: "234", rating: "", employees: "56", vacancies: "36", tooltips: [{ title: "Add to Wishlist", icon: "heart" }] },
                { logo: companyLogos7, name: "Spoteck Solutions Pvt Ltd ", location: "Gachibowli, Banglore,", establishment: "Establishment year - 2002", reviews: "239", rating: "4", employees: "100", vacancies: "36", tooltips: [{ title: "Add to Wishlist", icon: "heart" }] },
                { logo: companyLogos5, name: "Vehement Capital Partners", location: "Gachibowli, Banglore,", establishment: "Establishment year - 2017", reviews: "239", rating: "4.5", employees: "120", vacancies: "10", tooltips: [{ title: "Add to Wishlist", icon: "heart" }, { title: "Share this company", icon: "share" }] },
                { logo: companyLogos6, name: "Wonka Industries ", location: "Kukatpally, Hyderabad,", establishment: "Establishment year - 2000", reviews: "764", rating: "4", employees: "120", vacancies: "10", tooltips: [{ title: "Add to Wishlist", icon: "heart" }, { title: "Share this company", icon: "share" }] },
            ]
        };
    },
};
    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="p-4 border-bottom">
                            ...
                            <div class="px-2 py-3 pb-0">
                                ...
                                <a class="ecommerce-more-link" data-bs-toggle="collapse" href="#location-more"
                                    role="button" aria-expanded="false" aria-controls="location-more">MORE</a>
                            </div>
                        </div>
                        <div class="p-4 border-bottom">
                        ...
                        <div class="p-4 border-bottom">
                            ...
                            <div class="px-2 py-3 pb-0">
                                <div class="form-check mb-2">
                                    <input class="form-check-input me-2" type="checkbox" value="" id="Recruiter-1"
                                        checked>
                        ...
                        <div class="p-4 border-bottom">
                            ...
                            <div class="px-2 py-3 pb-0">
                                <div class="form-check mb-2">
                                    <input class="form-check-input me-2" type="checkbox" value="" id="vacancies-1"
                                        checked>
            ...
            <div class="col-xxl-9 col-lg-7">
                <div class="row align-items-center mb-4">
                    <div class="col-lg-12">
                        <div class="input-group companies-search-input">
                            ...
                            <multiselect1 :show-labels="false" class="rounded-0 w-sm-25" name="category" id="category"
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap gap-2">
                            <h5 class="fw-semibold mb-0 flex-grow-1">1287 <span class="fw-normal fs-18">Companies match
                                    for
                                    your search</span> </h5>
                            <div class="btn-group">
                ...
                <searchcompany :companyListData=companyListData />
