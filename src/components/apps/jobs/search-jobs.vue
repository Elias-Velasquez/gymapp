...
import FindJobComponent from "../../../shared/components/@spk/apps/joblanding-findjobs-cards.vue";
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="">
                            ...
                            <p>Latest jobs updates on the go to recieved direct to your email. Stay updated with your
                                latest new jobs.</p>
            ...
            <div class="col-xxl-9 col-xl-8">
                <div v-for="card in findjobs3">
                    <FindJobComponent :card="card" cardBodyClass="featured-jobs" />
                </div>
