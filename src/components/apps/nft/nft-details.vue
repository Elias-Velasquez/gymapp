...
import { ref } from "vue";
import * as nftDetailsjsData from "../../../data/apps/nft/nft-details";
                        ...
                        <div class="col-xxl-4 col-xl-12">
                            <div class="row">
                                <div class="col-xxl-12 col-sm-12 mb-md-5 mb-3">
                                    <SwiperjsCardComponent :swiperItems="nftDetailsjsData.thumbsGallery"
                                        swiperClass="mySwiper2" :style="{
                                            '--swiper-navigation-color': '#fff',
                                            '--swiper-pagination-color': '#fff',
                                        }" :spaceBetween="10" :pagination="false" :navigation="true"
                                    ...
                                    <SwiperjsCardComponent :swiperItems="nftDetailsjsData.thumbsGallery"
                                        swiperClass="mySwiper mt-2" @swiper="setThumbsSwiper" :spaceBetween="10"
                                ...
                                <div class="col-xxl-12 col-sm-12 d-md-block d-none">
                                    ...
                                    <div class="table-responsive overflow-hidden">
                                        <table class="table table-bordered text-nowrap">
                                            <tbody>
                                                <tr v-for="(row, index) in nftDetailsjsData.Featured" :key="index">
                                                    <td>
                                                            ...
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="flex-fill">
                                                                    ...
                                                                    <p class="mb-0">
                                                                        ...
                                                                        <span class="text-muted ms-1">({{ row.totalLikes
                                                                        }})</span>
                                                                    </p>
                                                                </div>
                                                                <div class="text-center">
                                                                    <p class="mb-0 fs-16 fw-semibold">
                                                                        <span
                                                                            class="avatar avatar-xs avatar-rounded p-1">
                                                                            <img src="/images/crypto-currencies/regular/Ethereum.svg"
                                                                                alt="">
                                                                        </span>{{ row.price }}
                                                                    </p>
                            ...
                            <div class="row gx-5">
                                <div class="col-xl-12 mt-xxl-0 mt-3">
                                    <div>
                                        ...
                                        <p class="fs-18 mb-4">
                                            <i class="ri-heart-3-fill text-danger align-middle me-1 d-inline-block"></i>
                                            <span class="fw-semibold text-muted"><a class="text-info fs-14"
                                                    href="javascript:void(0);">(2.4k
                                                    Likes)</a></span>
                                        </p>
                                        <div class="row mb-4">
                                            <div class="col-xxl-3 col-xl-12">
                                                ...
                                                <p class="mb-1"><span class="h3"><span
                                                        ...
                                                        class="ms-3 badge bg-danger-transparent">50%
                                                        Off</span></p>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="text-muted mb-0">
                                                ...
                                                forms. The artwork is a digital representation of the artist's
                                                imagination,
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-10">
                                                    <TableComponent :headers="[]" :rows="nftDetailsjsData.details"
                                                        tableClass="table table-bordered text-nowrap"
                                                        v-slot:cell="{ row }">
                                                ...
                                                <div
                                                    ...
                                                    <div class="border p-3">
                                                        <div class="d-sm-flex d-block align-items-top mb-3">
                                                            <div class="d-flex flex-fill">
                                                                ...
                                                                <div class="lh-1 me-2">
                                                                    ...
                                                                    <div class="mb-1">
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle me-1 fs-12"></i>
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle me-1 fs-12"></i>
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle me-1 fs-12"></i>
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle me-1 fs-12"></i>
                                                                        <i
                                                                            class="ri-star-line text-warning align-middle me-1 fs-12"></i>
                                                                    </div>
                                                        ...
                                                        <div class="ps-sm-4 ps-0 mb-3">
                                                            <p class="fw-semibold mb-1 ps-2">Truely amazing NFT&#128512;
                                                            </p>
                                                            <p class="mb-0 fs-12 text-muted ps-2">Digital Dreamspace is
                                                                a
                                                                truly captivating NFT that takes you on an unforgettable
                                                                journey. The artwork's vivid colors and ethereal
                                                                elements
