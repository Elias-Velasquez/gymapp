...
import ecommers3 from "/images/ecommerce/jpg/3.jpg";
import ecommers4 from "/images/ecommerce/jpg/4.jpg";
import ecommers6 from "/images/ecommerce/jpg/6.jpg";
...
export default {
    ...
    data() {
        return {
            dataToPass: {
                current: "Nav & Tabs",
                list: ['UI-Elements', 'Nav & Tabs']
            },
            tanStyle: [
                { image: ecommers3, name: "Stop Watch", category: "Clocks", price: "$1,299.00" },
                { image: ecommers4, name: "Camera", category: "Gadgets", price: "$7,249.29" },
                { image: ecommers6, name: "Shoes", category: "Footwear", price: "$799.00" },
            ]
        };
    },
};
...
<template>
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="Static Tabs">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Static Pills">
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title=" Default Nav Tabs">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Justified Nav Tabs">
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="Basic Pill Tabs With Links">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Justified Pill Tabs With Links">
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="Vertical alignment with lists">
                <div class="row">
                    <div class="col-xl-3">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Vertical alignment with links">
                <div class="row">
                    <div class="col-xl-3">
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="Center Aligned Nav">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Right Aligned Nav">
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Footer Tabs" :showCardFooter="true">
                <div class="tab-content">
    ...
    <div class="row">
        <div class="col-xxl-4 col-xl-12">
            <SimpleCardComponent title="Tab Style-1">
        ...
        <div class="col-xxl-4 col-xl-6">
            <SimpleCardComponent title="Tab Style-2">
                <ul class="nav nav-tabs tab-style-2 nav-justified mb-3 d-sm-flex d-block" id="myTab1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="shipped-tab" data-bs-toggle="tab"
                            data-bs-target="#shipped-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane"
                            aria-selected="false"><i
        ...
        <div class="col-xxl-4 col-xl-6">
            <SimpleCardComponent title="Tab-Style-3">
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="Tab Style-4">
                <nav>
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="Tab Style-5">
    ...
    <div class="row">
        <div class="col-xl-4">
            <SimpleCardComponent title="Tab Style-6">
                <ul class="nav nav-tabs mb-3 tab-style-6" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="sales-tab" data-bs-toggle="tab" data-bs-target="#sales-tab-pane"
                            type="button" role="tab" aria-controls="sales-tab-pane" aria-selected="false"><i
                ...
                <div class="tab-content" id="myTabContent2">
                    <div class="tab-pane fade show active p-0 border-bottom-0" id="products-tab-pane" role="tabpanel"
                        ...
                        <TableComponent :headers="['Name', 'Created On', 'Number', 'Status']" :rows="tanStyle"
                            tableClass="table mb-0" v-slot:cell="{ row }">
                            <td>
        ...
        <div class="col-xl-8">
            <SimpleCardComponent title="Vertical Tab Style-1" cardClassBody="d-flex align-items-start">
                <div class="row">
                    <div class="col-md-2">
                                    ...
                                    <div>
                                        <div class="my-md-auto mt-4 ms-md-3">
                                            ...
                                            <p class="text-muted ms-0 mb-2 pb-2 "> <span class="me-3"><i
                                                    ...
                                                    fransisco,Alabama</span> <span><i class="far fa-flag me-2"></i>New
                                                    Jersey</span> </p>
    ...
    <div class="row">
        <div class="col-xxl-6">
            <SimpleCardComponent title="Vertical Tab Style-2">
                <div class="row">
                    <div class="col-md-3">
                            ...
                            <div class="tab-pane text-muted" id="about-vertical-custom" role="tabpanel">
                                <ul class="mb-0">
                                    <li class="mb-2">
                                        ...
                                        versions from the 1914 translation by H. Rackham,How hotel deals can help you
                                        live a
                                        better life. <b>How celebrity
                                            cruises</b>
                                    </li>
                                    <li>
                                        Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
        ...
        <div class="col-xxl-6">
            <SimpleCardComponent title="Vertical Tab Style-3">
                <div class="row">
                    <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="Tabs with dropdowns">
                <ul class="nav nav-tabs mb-3 border-0" role="tablist">
                    <li class="nav-item">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title=" Pills with dropdowns" customCardClass="overflow-visible">
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent title="FIll Pills">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title="justified Pills">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Working with flex utilities">
