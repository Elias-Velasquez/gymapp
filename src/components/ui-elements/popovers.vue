...
import * as prism from '../../data/prismCode/ui-elements/popover';
...
export default {
    ...
    data() {
        return {
            ...
            dataToPass: {
                current: "Popovers",
                list: ['UI-Elements', 'Popovers']
            },
            prism
        };
    },
    mounted() {
        // Initialize popovers on all elements with 'data-bs-toggle="popover"'
    ...
    unmounted() {
        // Cleanup all popovers when the component is destroyed
        const popovers = document.querySelectorAll('.popover');
        popovers.forEach(item => {
            item.remove();  // Remove popover elements
        });
    }
};
</script>
            ...
            <showcodeCard title="Colored Popovers" :code="prism.coloredPopovers">
                <div class="btn-list">
                    ...
                    <button type="button" class="btn btn-teal btn-wave" data-bs-toggle="popover"
                        data-bs-placement="bottom" data-bs-custom-class="popover-teal" title="Color Background"
                        data-bs-content="Popover with teal background.">
                        Teal
                    </button>
                    <button type="button" class="btn btn-purple btn-wave" data-bs-toggle="popover"
                        data-bs-placement="left" data-bs-custom-class="popover-purple" title="Color Background"
        ...
        <div class="col-xl-6">
            <showcodeCard title="Dismissible Popovers" :code="prism.DismissiblePopovers"
                ...
                <a tabindex="0" class="btn btn-primary m-1" role="button" data-bs-toggle="popover"
                    ...
                    data-bs-original-title="Dismissible popover">Popover Dismiss </a>
                <a tabindex="0" class="btn btn-secondary m-1" role="button" data-bs-toggle="popover"
                    data-bs-trigger="focus" data-bs-placement="right"
                    data-bs-content="And here's some amazing content. It's very engaging. Right?"
                    data-bs-original-title="Dismissible popover">Popover Dismiss </a>
                <a tabindex="0" class="btn btn-info m-1" role="button" data-bs-toggle="popover" data-bs-trigger="focus"
