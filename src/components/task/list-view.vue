...
import { listViewOptions, listViewSeries, totalTasks } from '../../data/list-view';
import { ref } from "vue";
                                    ...
                                    <div class="modal-body px-4">
                                        <div class="row gy-2">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <multiselect1 :show-labels="false" v-model="statusValue"
                                                    :options="statusOptions" placeholder="Status">
                                                </multiselect1>
                                            </div>
                                            <div class="col-xl-6">
                                                <label class="form-label">Priority</label>
                                                <multiselect1 :show-labels="false" v-model="priorityValue"
                                                    :options="priorityOptions" placeholder="Priority">
                                                </multiselect1>
                                            </div>
                                            <div class="col-xl-12">
                                                <label class="form-label">Assign To</label>
                                                <multiselect1 :show-labels="false" v-model="assignToValue"
                ...
                <div class="card-body p-0">
                    ...
                    <div class="d-flex align-items-top p-4 border-bottom border-block-end-dashed">
                        ...
                        <div class="flex-fill">
                            ...
                            <div>
                                <h4 class="fs-18 fw-semibold mb-2"><span class="count-up" data-count="81">81</span><span
                                        class="text-muted float-end fs-11 fw-normal">Last Year</span></h4>
                                <p class="text-muted fs-11 mb-0 lh-1">
                                    <span class="text-success me-1 fw-semibold">
